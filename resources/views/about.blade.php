    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-7 col-md-6 text-center text-md-start padding-eight-lr lg-padding-six-lr md-padding-15px-lr wow animate__fadeInRight" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInRight;">
                ...
                <p>We are a UK based company having our garments production back in India manufacturing uniforms. As our name signifies we are committed to bringing quality fabric into unique designing and tailoring with added values and functionality. Safety, comfort and style are intervowen while crafting our designs. Health standards are ensured through internationally approved lab tests. We cater to range of minimum and bulk orders. Potential for branding with customized embroidery and design are our speciality. We are unique to address the requirements of the customers ensuring ethnic and gender specific needs. Made to order uniforms for any sector within a timeframe is possible with us. Any sizes in durable, sustainable and stretchable fabric are our commitment.</p>
            </div>
        </div>
    </div>
</section>
